...
| **SSL Data Storage & Management** | **AS A:** End User<br>**I WANT:** My data to be saved reliably with high performance even when dealing with thousands of notes<br>**SO THAT:** I don't lose any important transcriptions or AI-generated insights due to data corruption. | **Given:** The user continuously creates or updates multiple notes.<br>**When:** The application performs data saving operations.<br>**Then:** The system securely writes the data into a robust local SQLite database using parameterized queries, ensuring data integrity and preventing SQL injection. |
| **SSL Data Storage & Management** | **AS A:** End User<br>**I WANT:** To perform advanced keyword searches across all my past notes<br>**SO THAT:** I can quickly locate specific information I recorded previously. | **Given:** The user wants to find a specific past record.<br>**When:** The user enters a keyword in the search bar.<br>**Then:** The system queries the local database and instantly returns notes containing the keyword within their title, transcript, or AI-generated summary. |
| **SSL Data Management** | **AS A:** End User<br>**I WANT:** To modify the attributes of existing notes at any time (e.g., renaming titles, moving folders, or appending AI conversations)<br>**SO THAT:** I can keep my note classifications accurate and the content up-to-date. | **Given:** The user is viewing an existing note.<br>**When:** The user alters the title, changes the folder, or has a new conversation with the AI.<br>**Then:** The system executes a "Partial Update," precisely modifying only the altered fields and automatically updating the `updatedAt` timestamp, without affecting any other existing content in the note. |
| **SSL Data Management** | **AS A:** End User<br>**I WANT:** To categorize and filter my notes using folders and AI-generated tags<br>**SO THAT:** I can keep my workspace organized and retrieve related concepts efficiently. | **Given:** The user has accumulated multiple notes with various tags and folders.<br>**When:** The user selects a specific folder from the menu or clicks on a tag.<br>**Then:** The application executes a dynamic SQL query to display only the notes matching the exact folder or tag criteria. |
| **SSL Data Management** | **AS A:** End User<br>**I WANT:** A trash bin feature for deleted notes<br>**SO THAT:** I can recover notes I accidentally deleted before they are permanently erased. | **Given:** The user accidentally clicks the delete button on a note.<br>**When:** The delete action is executed.<br>**Then:** The system soft-deletes the note by moving it to the Trash (marking the `deletedAt` timestamp), allowing the user to safely restore it or permanently delete it later. |
